package com.nhnacademy.mini_dooray.gateway.comment.service;

import com.nhnacademy.mini_dooray.gateway.comment.domain.CommentRegistrationRequest;
import com.nhnacademy.mini_dooray.gateway.comment.domain.CommentResponse;
import com.nhnacademy.mini_dooray.gateway.comment.domain.CommentUpdateRequest;
import com.nhnacademy.mini_dooray.gateway.comment.exception.CommentDeletedFailedException;
import com.nhnacademy.mini_dooray.gateway.comment.exception.CommentGetException;
import com.nhnacademy.mini_dooray.gateway.comment.exception.CommentRegistrationFailedException;
import com.nhnacademy.mini_dooray.gateway.comment.exception.CommentUpdateFailedException;
